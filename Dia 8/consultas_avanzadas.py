...
def consultas_avanzadas():
    ...
    try:
        ...
        while True:
            try:
                n = int(input("\nIntroduce la cota minima de asignaturas: ").strip())
                if 0 <= n <= 40:
                    break
                else:
                    print("El valor tiene que ser un numero entero y estar entre 0 y 40.")
            except ValueError:
        ...
        print("\n----- Proyección: Solo queremos el nombre y licenciatura (excluyendo el _id y los demas campos) de los primeros 5 alumnos ingresados al sistema -----")
